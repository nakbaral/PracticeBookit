...
public class Driver {
    ...
    public static final String USERNAME = "nargizaakbaralie2";
    public static final String AUTOMATE_KEY = "PUpTsVqBCKfXCcfqocyU";
    ...
    public synchronized static WebDriver getDriver() {
        String GRID_URL = "http://100.25.146.223:4444/wd/hub";
